def add_decoder_args(parser):
    ...
    beam_args.add_argument('--beam-width', default=3, type=int, help='Beam width to use')
    beam_args.add_argument('--lm-path', default=None, type=str,
                           help='Path to an (optional) kenlm language model for use with beam search (req\'d with trie)')
    beam_args.add_argument('--alpha', default=0.0, type=float, help='Language model weight')
    beam_args.add_argument('--beta', default=0.0, type=float, help='Language model word bonus (all words)')
    beam_args.add_argument('--cutoff-top-n', default=6, type=int,
